...
loginsdm.getContentPane().setBackground(new Color(20, 30, 60));

loginsdm.setTitle("STUDENT DATA MANAGEMENT Login\r\n");

loginsdm.setIconImage(Toolkit.getDefaultToolkit().getImage("\"C:\\Users\\Pavithra\\OneDrive\\Desktop\\STD.jpg\""));
...
//unPrepared statement has prepared: "SELECT * from login where username = "pavi@123" and pass ="pavithra";
...
lblNewLabel_1.setIcon(new ImageIcon("\"C:\\Users\\Pavithra\\OneDrive\\Pictures\\calm.jpg\""));
